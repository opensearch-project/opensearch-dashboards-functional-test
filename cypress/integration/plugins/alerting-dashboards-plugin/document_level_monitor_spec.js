...
describe('DocumentLevelMonitor', () => {
  ...
  describe('can be created', () => {
    ...
    it('by visual editor', () => {
      ...
      // Enter query field
      cy.get('[data-test-subj="documentLevelQuery_field0"]').type(
        'region{downarrow}{enter}'
      );

      // Enter query operator
      cy.get('[data-test-subj="documentLevelQuery_operator0"]').type(
        'is{enter}'
      );
      ...
      // Enter query tags
      cy.get('[data-test-subj="addDocLevelQueryTagButton_query0"]')
        .click()
        .click();
      cy.get(
        '[data-test-subj="documentLevelQueryTag_text_field_query0_tag0"]'
      ).type(
  ...
  describe('can be updated', () => {
    ...
    describe('when defined with visual editor', () => {
      it('with a new query and a new trigger', () => {
        ...
        // Enter query tags
        cy.get('[data-test-subj="addDocLevelQueryTagButton_query3"]')
          .click()
          .click();
        cy.get(
