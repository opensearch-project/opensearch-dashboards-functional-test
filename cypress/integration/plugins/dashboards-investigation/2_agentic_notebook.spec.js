...
describe('Agentic Notebook Investigation Tests', () => {
  ...
  describe('Investigation from multiple log entries', () => {
    ...
    it('should navigate to hypothesis detail', () => {
      cy.get(SELECTORS.hypothesisItem)
        ...
        .within(() => {
          ...
          cy.get('div.euiTextColor--subdued').should('contain.text', 'Updated');
        });
    ...
    it('should reinvestigate with new question', () => {
      ...
      cy.contains('Bring the existing hypotheses and findings').should('exist');
  ...
  // TODO: Add 'Investigation from chatbot' tests (trigger investigation from alert details)
});
