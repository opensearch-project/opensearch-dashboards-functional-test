...
describe('Has working breadcrumbs', () => {
  it('Redirect to correct page on breadcrumb click', () => {
    landOnEventExplorer();
    cy.get('.euiBreadcrumb[href="#/event_analytics/explorer"]')
      .contains('Explorer')
      .click();
    cy.get('[data-test-subj="searchAutocompleteTextArea"]').should('exist');
    cy.get('.euiBreadcrumb[href="#/event_analytics"]')
      .contains('Event analytics')
      .click();
    cy.get('.euiTitle').contains('Event analytics').should('exist');
    cy.get('.euiBreadcrumb[href="observability-dashboards#/"]')
