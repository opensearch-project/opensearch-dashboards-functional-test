...
describe('Testing panels table', () => {
  ...
  it('Deletes panels', () => {
    ...
    cy.get('button[data-test-subj="popoverModal__deleteButton"]').should(
      'be.disabled'
    );
...
describe('Testing a panel', () => {
  ...
  it('Redirects to correct page on breadcrumb click', () => {
    ...
    cy.get('h1[data-test-subj="panelNameHeader"]')
      .contains(TEST_PANEL)
      .should('exist');
    cy.get('a[data-test-subj="breadcrumb"]')
      .contains('Operational panels')
      .click();
    cy.get('a[data-test-subj="breadcrumb last"]')
      .contains('Operational panels')
      .should('exist');
    cy.get('a[data-test-subj="breadcrumb first"]')
  ...
  it('Change date filter of the panel', () => {
    ...
    cy.get(
      'button[data-test-subj="superDatePickerCommonlyUsed_This_year"]'
    ).click();
    cy.get(
  ...
  it('Add ppl filter to panel', () => {
    ...
    cy.get('.xtick')
      .contains('OpenSearch Dashboards Airlines')
      .should('not.exist');
  });
