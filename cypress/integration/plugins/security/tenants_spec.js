...
if(Cypress.env("SECURITY_ENABLED")) {
  ...
  describe('Tenants page', () => {
    ...
    it('should create new tenant successfully by selecting `Create tenant`', () => {
      ...
      cy.get('input[data-test-subj="name-text"]').type(tenantName, { force: true });
      cy.get('input[data-test-subj="name-text"]').should('have.value', tenantName);
  
      cy.get('textarea[data-test-subj="tenant-description"]').type(tenantDescription, { force: true });
      cy.get('textarea[data-test-subj="tenant-description"]').should('have.value', tenantDescription);
