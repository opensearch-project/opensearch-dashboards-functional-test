...
declare namespace Cypress {
  interface Chainable<Subject> {
    ...
    tbSetupRangeAggregation(
      field: string,
      range: Array<Array<string>>,
      id: number
    ): Chainable<any>;
    // Date Histogram
