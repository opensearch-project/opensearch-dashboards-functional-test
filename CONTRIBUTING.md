...
Suppose your plugin is ready for version 1.0.0

```
./build.sh manifests/1.0.0/opensearch-1.0.0.yml

./build.sh manifests/1.0.0/opensearch-dashboards-1.0.0.yml

./assemble.sh builds/opensearch/manifest.yml

./assemble.sh builds/opensearch-dashboards/manifest.yml

./test.sh integ-test manifests/1.0.0/opensearch-dashboards-1.0.0-test.yml
